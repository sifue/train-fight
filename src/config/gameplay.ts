...
export const PLAYER_DASH_HIT_DAMAGE_MULTIPLIER = 1.5;
export const PLAYER_DASH_HIT_KNOCKBACK_MULTIPLIER = 1.45;
export const PLAYER_WALK_SPEED = 220;
export const PLAYER_RUN_SPEED = 300;
export const PLAYER_DASH_STAMINA_MAX = 100;
export const PLAYER_DASH_DRAIN_PER_SEC = 34;
export const PLAYER_DASH_RECOVER_PER_SEC = 24;
export const PLAYER_DASH_TURN_SPEED = 90;
export const PLAYER_DASH_TURN_VELOCITY_GATE = 85;
